...
use Omnipay\PayUnity\Message\PostCaptureRequest;

class PostCaptureRequestTest extends TestCase
{
    public function setUp()
    {
        $request = new PostCaptureRequest($this->getHttpClient(), $this->getHttpRequest());
    ...
    {
        $this->assertSame($this->request, $this->request->setAmount('1.40'));
    ...
    public function testFill()
    {
        ...
        $requestA = new PostCaptureRequest($this->getHttpClient(), $this->getHttpRequest());
        ...
        $requestB = new PostCaptureRequest($this->getHttpClient(), $this->getHttpRequest());
